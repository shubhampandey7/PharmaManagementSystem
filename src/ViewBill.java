...
public class ViewBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(803, 16, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 75, 850, 380));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            while (rs.next()) {
                dtm.addRow(new Object[]{rs.getString("billId"), rs.getString("billDate"), rs.getString("totalPaid"), rs.getString("generatedBy")});
            }
        } catch (Exception e) {
    ...
    private void billTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_billTableMouseClicked
        ...
        TableModel tb=(TableModel)billTable.getModel();
        String id = tb.getValueAt(index, 0).toString();
        int a = JOptionPane.showConfirmDialog(null, "Do You Want to Open Selected Bill", "Select", JOptionPane.YES_NO_OPTION);
        if (a == 0) {
            OpenPdf.openById(id);
        }
